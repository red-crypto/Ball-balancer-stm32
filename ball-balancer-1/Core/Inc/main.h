...
#define X_POS_GPIO_Port GPIOC
#define Y_NEG_Pin GPIO_PIN_1
#define Y_NEG_GPIO_Port GPIOC
#define X_POSC2_Pin GPIO_PIN_2
#define X_POSC2_GPIO_Port GPIOC
#define Y_POS_Pin GPIO_PIN_3
#define Y_POS_GPIO_Port GPIOC
...
#define MOTOR_B_STEP_Pin GPIO_PIN_8
#define MOTOR_B_STEP_GPIO_Port GPIOA
#define MOTOR_B_DIR_Pin GPIO_PIN_9
