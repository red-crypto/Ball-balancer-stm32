...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|MOTOR_C_STEP_Pin|MOTOR_C_DIR_Pin|MOTOR_B_STEP_Pin
  ...
  GPIO_InitStruct.Pin = Y_NEG_Pin|X_POSC2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin */
  GPIO_InitStruct.Pin = LD2_Pin|MOTOR_C_STEP_Pin|MOTOR_C_DIR_Pin|MOTOR_B_STEP_Pin
                          |MOTOR_B_DIR_Pin;
